    ...
    <div class="row">
                    ...
                    <li class="dropdown divided">
                        ...
                        <ul class="dropdown-menu wider arrow nopadding messages">
                            ...
                            <li>
                                <a class="cyan" href="#">
                                    <div class="profile-photo">
                                        <img src="{{asset('assets/images/ici-avatar.jpg')}}" alt />
                                    </div>
                            ...
                            <li>
                                <a class="green" href="#">
                                    <div class="profile-photo">
                                        <img src="{{asset('assets/images/arnold-avatar.jpg')}}" alt />
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a class="red" href="#">
                                    <div class="profile-photo">
                                        <img src="{{asset('assets/images/peter-avatar.jpg')}}" alt />
                                    </div>
                                    <div class="message-info">
                            ...
                            <li>
                                <a class="orange" href="#">
                                    <div class="profile-photo">
                                        <img src="{{asset('assets/images/george-avatar.jpg')}}" alt />
                                    </div>
                                    <div class="message-info">
        ...
        <div id="content" class="col-md-12">
            ...
            <div class="pageheader">
                ...
                <h2><i class="fa fa-lightbulb-o" style="line-height: 48px;padding-left: 0;"></i> @yield('title') <span>// 我的愿望是：没有bug</span></h2>
                ...
                <div class="tab-pane active" id="mmenu-users">
                    ...
                    <ul class="users-list">
                        ...
                        <li class="online">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/ici-avatar.jpg')}}" alt>
                                </a>
                        ...
                        <li class="online">
                            <div class="media">
                                ...
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/arnold-avatar.jpg')}}" alt>
                                </a>
                        ...
                        <li class="online">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/peter-avatar.jpg')}}" alt>
                        ...
                        <li class="online">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/george-avatar.jpg')}}" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="busy">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar1.jpg')}}" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="busy">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar2.jpg')}}" alt>
                                </a>
                                <div class="media-body">
                    ...
                    <ul class="users-list">
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar4.jpg')}}" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="offline">
                            <div class="media">
                                ...
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar5.jpg')}}" alt>
                                </a>
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar6.jpg')}}" alt>
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar7.jpg')}}" alt>
                                </a>
                                <div class="media-body">
                        ...
                        <li class="offline">
                            <div class="media">
                                <a class="pull-left profile-photo" href="#">
                                    <img class="media-object" src="{{asset('assets/images/random-avatar8.jpg')}}" alt>
                                </a>
                                <div class="media-body">
